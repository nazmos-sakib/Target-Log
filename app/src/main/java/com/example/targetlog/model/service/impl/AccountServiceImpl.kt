...
class AccountServiceImpl @Inject constructor() : AccountService {
        ...
        get() = callbackFlow {
            val listener =
                FirebaseAuth.AuthStateListener { auth ->
                    this.trySend(auth.currentUser.toLocalUser())
                }
    ...
    override fun getUserProfile(): User {
        return Firebase.auth.currentUser.toLocalUser()
    }
    ...
    override suspend fun createAccountWithEmailPassword(email: String, password: String) {
